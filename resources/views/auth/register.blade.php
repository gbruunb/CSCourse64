<x-guest-layout>
    <x-authentication-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div>
                <x-label for="student_id" value="{{ __('รหัสนักศึกษา') }}" />
                <x-input id="student_id" class="block mt-1 w-full" type="text" name="student_id" :value="old('student_id')" required autofocus autocomplete="student_id" />
            </div>

            <div>
                <x-label for="firstname" value="{{ __('ชื่อจริง') }}" />
            ...
            <div>
                <x-label for="year" value="{{ __('ชั้นปีที่') }}" />
                <x-input id="year" class="block mt-1 w-full" type="text" name="year" :value="old('year')" required autofocus autocomplete="year" />
            </div>
